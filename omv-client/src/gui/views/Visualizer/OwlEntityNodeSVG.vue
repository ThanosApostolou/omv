<template>
    <svg v-if="owlentitysvg.visible">
        <svg class="svg" @click="showEntity(owlentitysvg.owlentity)">
            ...
            <text :x="owlentitysvg.textx" :y="owlentitysvg.texty" :font-size="owlentitysvg.fontSize" :text-anchor="owlentitysvg.textAnchor" :textLength="owlentitysvg.textLength" :font-weight="owlentitysvg.hasRule ? 'bold' : 'normal'"> {{ owlentitysvg.owlentity.label }}</text>
